...
def combined_plots(X_train, X_test, y_train, y_test, dic_pgd, pp, pp1, pp2, pp3, pp4,thee,index):
    ...
    # ax[0].scatter(X_pca[labs == 0, 0], X_pca[labs == 0, 1], color='blue', label='{:}'.format(pp1), marker='o', s=200)
    # ax[0].scatter(X_pca[labs == 1, 0], X_pca[labs == 1, 1], color='red', label='{:}'.format(pp2), marker='o', s=200)
    # ax[0].scatter(X_pca[labs == 2, 0], X_pca[labs == 2, 1], color='g', label='{:}'.format(pp3), marker='X', s=200)
    # ax[0].scatter(X_pca[labs == 3, 0], X_pca[labs == 3, 1], color='k', label='{:}'.format(pp4), marker='X', s=200)
    # ax[0].legend(title='{:}'.format(thee), title_fontsize='x-large', fontsize=16)
    ...
    # X_pca = pca.fit_transform(DC)
    # labs = np.array([0] * qa  + [1] * (A.shape[0] - qa) + [2]*qb + [3] * (B.shape[0] - qb))
    # ax[1].scatter(X_pca[labs == 0, 0], X_pca[labs == 0, 1], color='blue', label='{:}'.format(pp1), marker='o', s=200)
    # ax[1].scatter(X_pca[labs == 1, 0], X_pca[labs == 1, 1], color='red', label='{:}'.format(pp2), marker='o', s=200)
    # ax[1].scatter(X_pca[labs == 2, 0], X_pca[labs == 2, 1], color='g', label='{:}'.format(pp3), marker='X', s=200)
    # ax[1].scatter(X_pca[labs == 3, 0], X_pca[labs == 3, 1], color='k', label='{:}'.format(pp4), marker='X', s=200)
    # ax[1].legend(title='{:}'.format(thee), title_fontsize='x-large', fontsize=16)
    # ax[1].set_xlabel('PC1', fontsize=16)
    # ax[1].set_ylabel('PC2', fontsize=16)
    ...
    ax[0].legend(handles=legend_elements, title='{:}'.format(thee), title_fontsize='x-large', fontsize=16)
    ...
    ax[1].legend(handles=legend_elements, title='{:}'.format(thee), title_fontsize='x-large', fontsize=16)
    ...
    ax[2].legend(handles=legend_elements, title='{:}'.format(thee), title_fontsize='x-large', fontsize=16)
